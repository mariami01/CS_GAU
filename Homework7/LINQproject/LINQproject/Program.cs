    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var querySyntax8 = (from employee in employees
                                    //where employee.EmployeeName.StartsWith("G")
                                select employee).First();

            var methodSyntax8 = employees
                                //.Where(e => e.EmployeeName.StartsWith("N"))                 
                                .First();
            ...
            var querySyntax9 = (from employee in employees
                                    //where employee.EmployeeName.StartsWith("N")
